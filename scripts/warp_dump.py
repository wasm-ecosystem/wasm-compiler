...
parser.add_argument("--import-v2", nargs=3, action="append")
...
if imports_v2:
    for [module_name, func_name, signature] in imports_v2:
        compiler.register_api_v2(module_name, func_name, signature)
